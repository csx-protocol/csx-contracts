...
export const priceTypes = ['0', '0', '1', '0', '0', '2', '0'];
export const prices = ['2977130000000000', '8933480000000000', '27800000', '44661960000000000', '89323910000000000', '457000000', '1489077140000000000'];
export const names = ['R8 Revolver | Bone Mask (Field-Tested)', 'Negev | Bulkhead (Minimal Wear)', 'Negev | Army Sheen (Minimal Wear)', 'MAC-10 | Nuclear Garden (Field-Tested)', 'Galil AR | Rocket Pop (Factory New)', 'StatTrak™ AK-47 | Slate (Factory New)', '★ Driver Gloves | Rezan the Red (Minimal Wear)']
export const weaponTypes = ['R8 Revolver', 'Negev', 'Negev', 'MAC-10', 'Galil AR', 'AK-47', 'Driver Gloves'];
...
export const assetIds = ['GG1', '28492787574', 'GG2', '28315956209', '28315874929', '28229768155', '27955299910'];